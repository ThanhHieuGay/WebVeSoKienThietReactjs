// src/components/support/SupportArticleCard.jsx

import { Book } from 'lucide-react';

const SupportArticleCard = ({ article, animationDelay }) => {
  return (
    <div 
    ...
    >
      ...
      <div className="mb-4">
        <h4 className="font-semibold text-gray-800 mb-3">Hướng dẫn chi tiết:</h4>
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded-lg">
        <p className="text-sm text-gray-700">
          <span className="font-semibold">💡 Lưu ý: </span>{article.tips}
        </p>
      </div>
    </div>
  );
